...
ALU alu_unit(instruction, RFRD1, ALU2, ALUoutput, ALUOp, Zero);
Data_Memory data_memory (instruction, ALUoutput, RFRD2, Readdata, MemWrite, MemRead, clk, rst);
datamux data_mux(instruction, Readdata, ALUoutput, MemtoReg, MemMov, rst);

movk movk_md(instruction, RFRD2, RFWD, MovK, MemMov);
